...
Ext.require([
 ...
 Ext.QuickTips.init();
Ext.define('DC.view.Version.VersionInstall', {
			extend : 'Ext.grid.Panel',
			alias : 'widget.versionInstall',
			store : 'Version.VersionInstall',
			frame : true,
			multiSelect: true,
				...
				Ext.apply(this, {
							...
							,dockedItems : [{
								...
								items : [{
											...
											labelWidth : 40,
											xtype : 'searchfield',
											store : Ext.data.StoreManager.lookup('Version.VersionInstall')
										}]
							}, {
								xtype : 'pagingtoolbar',
								store : 'Version.VersionInstall',
