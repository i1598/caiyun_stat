...
function report($dateline, $member_id, $quantity_uninstall, $quantity_uninstall_24hless, $quantity_uninstall_24hmore){
    if($quantity_uninstall>0){ 
        ...
        if(empty($report_day_id)){
            ...
            $data['quantity_install'] = 0;
            $data['quantity_install_active'] = 0;
            $data['quantity_install_firstopen'] = 0;
            $data['quantity_reinstall'] = 0;
            $data['quantity_firstopen'] = 0;
            $data['quantity_active'] = 0;
            $data['quantity_ip'] = 0;
